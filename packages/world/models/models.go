...
type AgentRecord struct {
	...
	Version       string `json:"version,omitempty"`        // resolved agent version for this world
	RolloutCohort string `json:"rollout_cohort,omitempty"` // active or canary
	CanaryPercent int    `json:"canary_percent,omitempty"` // configured canary split at resolution time
